 ...
 * Stage 270: live chat (2026-09-24 11:08 CDT) reconfirmed session paste hash beec41f1.
...
export function confirmSessionKernel() {
  return {
    ...
    nodeCap: NODE_CAP,
    note: 'Session paste 2026-09-24 11:08 CDT matches beec41f1. Klein/hopf/figure8/trefoil stay runtime-only. Stage 270 compiled next hops; GPU/TF auto-enable at count>1024; instanceOffset band 4096-16384; CPU evaluate zeros non-finite coords.',
  };
}
